...
public class DayPickerView extends ListView implements AbsListView.OnScrollListener, DatePickerDialog.OnDateChangedListener {
    ...
    public void setIgnore(List<Calendar> dates)
    {
        ignore=dates;
    }

    public DayPickerView(Context context, DatePickerController datePickerController, List<Calendar> ignore) {
        super(context);
        this.ignore=ignore;
