...
public class SimpleMonthView extends View {
    ...
    public SimpleMonthView(Context context, List<Calendar> ignore) {
        super(context);
        this.ignore=ignore;
	...
	private void drawMonthDayLabels(Canvas canvas) {
        ...
        for (int i = 0; i < mNumDays; i++) {
            ...
            canvas.drawText(Month.getShortDate(mDayLabelCalendar.get(Calendar.DAY_OF_WEEK)), x, y, mMonthDayLabelPaint);
        }
	}
	...
	private String getMonthAndYearString() {
        ...
        return Month.getMouthNyNumber(mCalendar.get(Calendar.MONTH))+" "+mCalendar.get(Calendar.YEAR);
    }
	...
	protected void drawMonthNums(Canvas canvas) {
		...
		while (day <= mNumCells) {
            ...
            if(!isIgnored(getDayFromLocation(x, y))){
    ...
    public void setIgnored(List<Calendar> ignore)
    {
        this.ignore=ignore;
    }

    private boolean isIgnored(SimpleMonthAdapter.CalendarDay day)
    {
        ...
        {
            if(calendar.get(Calendar.DAY_OF_MONTH)==day.day&&calendar.get(Calendar.MONTH)==day.month
